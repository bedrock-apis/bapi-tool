...
export class PhysicalDirectory<Nullable extends boolean = true> extends VirtualDirectory<Nullable>{
    ...
    public openFile(name: string): PhysicalFile<false> {
        return new PhysicalFile<false>(name, this);
    }
    public openDirectory(name: string): PhysicalDirectory<false> {
    ...
    public readonly this.fullPath(): string{
    ...
    public async isValid(): Promise<boolean> { return this.hasDirectory("."); }
