...
export type ColorLike = number | string | bigint | { r: number | bigint, g: number | bigint, b: number | bigint};
export class TextFormatter{
    ...
    public static GetColorCode(r: number, g: number, b: number, background?: boolean){
